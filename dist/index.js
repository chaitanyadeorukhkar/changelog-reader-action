...
const { validateEntry } = __webpack_require__(312)
...
const { diff, lt, valid } = __webpack_require__(876)
const known = []
...
exports.validateEntry = (entry, idx) => {
  ...
  if (lastVersion && !lt(lastVersion, entry.id)) {  // Validate versions appear in reverse chronological order
...
const { prerelease } = __webpack_require__(876)
